  ...
  return (
    <div className="bg-surface-canvas text-on-surface font-body-main">
      ...
      <main className="pt-32">
        {/* Hero Section */}
        <section className="pt-40 pb-24 px-8 max-w-[1200px] mx-auto text-center">
          <h1 className="font-hero-title text-hero-title text-primary mb-6">EvoLeap AI 机构培训方案</h1>
          <p className="font-section-title text-section-title text-text-secondary">传统医疗 AI 转型实战课程</p>
        </section>

        {/* Section 1: 我们解决的问题 */}
        <section className="py-24 bg-surface-soft">
          <div className="max-w-[1200px] mx-auto px-8">
            <h2 className="font-section-title text-primary mb-12 text-center">我们解决的问题</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-surface-canvas p-6 rounded-xl border border-border-subtle hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                <span className="material-symbols-outlined text-text-tertiary mb-4">computer</span>
                <h3 className="font-card-title text-primary mb-3">买了系统不会用</h3>
                <p className="font-body-main text-text-secondary">医疗机构引进了先进的 AI 系统，但一线医护人员缺乏培训，导致系统闲置，无法发挥实际效用。</p>
              </div>
              <div className="bg-surface-canvas p-6 rounded-xl border border-border-subtle hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                <span className="material-symbols-outlined text-text-tertiary mb-4">database</span>
                <h3 className="font-card-title text-primary mb-3">有数据不会挖</h3>
                <p className="font-body-main text-text-secondary">积累了海量高质量的临床数据，却不知道如何利用 AI 工具进行深度挖掘和科研转化。</p>
              </div>
              <div className="bg-surface-canvas p-6 rounded-xl border border-border-subtle hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                <span className="material-symbols-outlined text-text-tertiary mb-4">forum</span>
                <h3 className="font-card-title text-primary mb-3">需求沟通不畅</h3>
                <p className="font-body-main text-text-secondary">临床医生与 AI 研发团队之间存在严重的认知壁垒，导致开发出的产品无法满足实际临床需求。</p>
              </div>
              <div className="bg-surface-canvas p-6 rounded-xl border border-border-subtle hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                <span className="material-symbols-outlined text-text-tertiary mb-4">lightbulb</span>
                <h3 className="font-card-title text-primary mb-3">缺乏创新思维</h3>
                <p className="font-body-main text-text-secondary">面对 AI 带来的行业变革，缺乏前瞻性思维和系统的方法论，难以在激烈的竞争中保持领先。</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-surface-canvas">
          <div className="max-w-[1200px] mx-auto px-8">
            <h2 className="font-section-title text-primary mb-12 text-center">课程模块</h2>
            <div className="space-y-8">
              <div className="border border-border-subtle rounded-xl overflow-hidden">
                <div className="bg-surface-soft p-6 border-b border-border-subtle">
                  <h3 className="font-card-title text-primary">模块一：AI 医疗基础认知与全景解析</h3>
                  <p className="font-meta-data text-text-secondary mt-1">目标：建立正确的 AI 认知，了解前沿趋势与应用边界。</p>
                </div>
              ...
              <div className="border border-border-subtle rounded-xl overflow-hidden">
                <div className="bg-surface-soft p-6 border-b border-border-subtle">
                  <h3 className="font-card-title text-primary">模块二：临床业务流程的 AI 重构</h3>
                  <p className="font-meta-data text-text-secondary mt-1">目标：掌握利用 AI 工具优化诊疗流程、提升效率的方法。</p>
                </div>
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex gap-3">
                    <span className="material-symbols-outlined text-text-tertiary mt-1">check_circle</span>
              ...
              <div className="border border-border-subtle rounded-xl overflow-hidden">
                <div className="bg-surface-soft p-6 border-b border-border-subtle">
                  <h3 className="font-card-title text-primary">模块三：临床数据资源的 AI 激活与挖掘</h3>
                  <p className="font-meta-data text-text-secondary mt-1">目标：打通数据孤岛，提升临床科研的数据利用能力。</p>
                </div>
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex gap-3">
                    <span className="material-symbols-outlined text-text-tertiary mt-1">check_circle</span>
              ...
              <div className="border border-border-subtle rounded-xl overflow-hidden">
                <div className="bg-surface-soft p-6 border-b border-border-subtle">
                  <h3 className="font-card-title text-primary">模块四：医工交叉项目的管理与沟通实务</h3>
                  <p className="font-meta-data text-text-secondary mt-1">目标：打破行业壁垒，建立高效的跨学科团队协作机制。</p>
                </div>
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex gap-3">
                    <span className="material-symbols-outlined text-text-tertiary mt-1">check_circle</span>
        ...
        <section className="py-24 bg-surface-soft">
          <div className="max-w-[1200px] mx-auto px-8">
            <h2 className="font-section-title text-primary mb-12 text-center">培训方式</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-surface-canvas p-8 rounded-xl border border-border-subtle">
                <h3 className="font-card-title text-error mb-6 flex items-center gap-2">
              ...
              <div className="bg-surface-canvas p-8 rounded-xl border border-border-subtle">
                <h3 className="font-card-title text-secondary-fixed-dim mb-6 flex items-center gap-2">
        ...
        <section className="py-24 bg-surface-canvas">
          <div className="max-w-[1200px] mx-auto px-8">
            <h2 className="font-section-title text-primary mb-12 text-center">讲师团队</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border border-border-subtle rounded-xl p-6 text-center hover:shadow-sm transition-all duration-300">
                ...
                <h3 className="font-card-title text-primary mb-1">资深医疗产品经理</h3>
              ...
              <div className="border border-border-subtle rounded-xl p-6 text-center hover:shadow-sm transition-all duration-300">
                ...
                <h3 className="font-card-title text-primary mb-1">医学数据工程师</h3>
              ...
              <div className="border border-border-subtle rounded-xl p-6 text-center hover:shadow-sm transition-all duration-300">
                ...
                <h3 className="font-card-title text-primary mb-1">临床应用转型顾问</h3>
        ...
        <section className="py-24 bg-surface-soft">
          <div className="max-w-[1200px] mx-auto px-8">
            <h2 className="font-section-title text-primary mb-12 text-center">往期反馈</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <blockquote className="bg-surface-canvas p-8 rounded-xl border border-border-subtle relative">
                ...
                <p className="font-body-main text-text-secondary italic mb-6">"以前觉得大模型是计算机专家的事，上完课发现，只要掌握正确的提问技巧，它能帮我省下一半整理病历的时间。"</p>
                <footer className="font-meta-data font-medium text-primary">— 某三甲医院 主治医师</footer>
              </blockquote>
              <blockquote className="bg-surface-canvas p-8 rounded-xl border border-border-subtle relative">
                <span className="material-symbols-outlined text-text-tertiary absolute top-6 right-6 opacity-20 text-4xl">format_quote</span>
                <p className="font-body-main text-text-secondary italic mb-6">"最实用的部分是医工交叉沟通那节课，终于知道怎么跟开发团队提需求，他们才听得懂了。"</p>
